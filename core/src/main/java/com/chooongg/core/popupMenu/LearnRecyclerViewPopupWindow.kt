...
internal class LearnRecyclerViewPopupWindow(
    ...
    private fun buildDropDown(): Int {
        ...
        val dropDownList = RecyclerView(context).apply {
            ...
            setPaddingRelative(
                this@LearnRecyclerViewPopupWindow.paddingStart,
                this@LearnRecyclerViewPopupWindow.paddingTop,
                this@LearnRecyclerViewPopupWindow.paddingEnd,
                this@LearnRecyclerViewPopupWindow.paddingBottom
            )
        }

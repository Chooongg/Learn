...
/**
 * Builder for creating a [LearnPopupMenu].
 *
 * The [LearnPopupMenu] must have at least one section.
...
class MaterialPopupMenuBuilder {
    ...
    fun build(): LearnPopupMenu {
        ...
        return LearnPopupMenu(
            style = style,
            sections = sections,
        ).apply {
            overlapAnchor = this@MaterialPopupMenuBuilder.overlapAnchor
            width = this@MaterialPopupMenuBuilder.width
    ...
    /**
     * Holds section info for the builder. This gets converted to [LearnPopupMenu.PopupMenuSection].
     */
    @PopupMenuMarker
    class SectionHolder {
        ...
        internal fun convertToPopupMenuSection(): LearnPopupMenu.PopupMenuSection {
            require(itemsHolderList.isNotEmpty()) { "Section '$this' has no items!" }
            return LearnPopupMenu.PopupMenuSection(
                title = title,
    ...
    /**
     * Holds section item info for the builder. This gets converted to [LearnPopupMenu.PopupMenuItem].
     */
    @PopupMenuMarker
    class ItemHolder : AbstractItemHolder() {
        ...
        override fun convertToPopupMenuItem(): LearnPopupMenu.PopupMenuItem {
            ...
            return LearnPopupMenu.PopupMenuItem(
                label = label,
                labelRes = labelRes,
    ...
    /**
     * Holds section custom item info for the builder. This gets converted to [LearnPopupMenu.PopupMenuCustomItem].
     */
    @PopupMenuMarker
    class CustomItemHolder : AbstractItemHolder() {
        ...
        override fun convertToPopupMenuItem(): LearnPopupMenu.PopupMenuCustomItem {
            require(layoutResId != 0) { "Layout resource ID must be set for a custom item!" }
            return LearnPopupMenu.PopupMenuCustomItem(
    ...
    abstract class AbstractItemHolder {
        ...
        internal abstract fun convertToPopupMenuItem(): LearnPopupMenu.AbstractPopupMenuItem
...
/**
 * Function to create a [LearnPopupMenu].
 * @param init block containing popup menu definition
 */
fun popupMenu(init: MaterialPopupMenuBuilder.() -> Unit): LearnPopupMenu {
